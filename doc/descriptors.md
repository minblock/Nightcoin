# Support for Output Descriptors in Nightcoin Core

Since Nightcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Nightcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Nightcoin Core wallets, a convenience function `combo` is
