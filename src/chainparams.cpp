...
{
    const char* pszTimestamp = "4/2/2020 Provigen Networks: Are cares powered by Georginas AI yet";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586084026, 2541944, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x31fcb1da7db3f51f517dcb83db180511045534b63bac7748559dcc776f3cbebf"));
        assert(genesis.hashMerkleRoot == uint256S("0x633add3f0eb88c3b2572b4cab7ff56a0807bc5da08b982c7a035237353d3099d"));
        ...
        vSeeds.emplace_back("seed-a.nightcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.nightcointools.com");
        vSeeds.emplace_back("dnsseed.nightcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 19723, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xea41ff255801a1e706d72700ce22a7d7246b500d2af97cf3b09dfcdb42c38ec8"));
        assert(genesis.hashMerkleRoot == uint256S("0x633add3f0eb88c3b2572b4cab7ff56a0807bc5da08b982c7a035237353d3099d"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.nightcointools.com");
        vSeeds.emplace_back("seed-b.nightcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb7054e06a1930b77dc3548c5b84a3eedf89b84d1dcec53db4cae22c379e39896"));
        assert(genesis.hashMerkleRoot == uint256S("0x633add3f0eb88c3b2572b4cab7ff56a0807bc5da08b982c7a035237353d3099d"));
