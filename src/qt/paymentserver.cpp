...
const char* BIP71_MIMETYPE_PAYMENT = "application/nightcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/nightcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/nightcoin-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start nightcoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("nightcoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'nightcoin://' is not a valid URI. Use 'nightcoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Nightcoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
