...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nightcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nightcoin-tx [options] <hex-tx> [commands]  Update hex-encoded nightcoin transaction\n" +
            "or:     nightcoin-tx [options] -create [commands]   Create hex-encoded nightcoin transaction\n" +
            "\n";
