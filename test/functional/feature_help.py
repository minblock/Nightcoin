...
"""Verify that starting nightcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nightcoin with -h for help text")
        ...
        self.log.info("Start nightcoin with -version for version information")
        ...
        self.log.info("Start nightcoind with -fakearg to make sure it does not start")
